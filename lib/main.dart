  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: everBlue),
        textTheme: textTheme.apply(bodyColor: everInk, displayColor: everInk),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(colors: [everBlue, everBlue2]),
        borderRadius: BorderRadius.circular(size * .28),
      ),
      child: Image.asset('assets/evermore_icon.png'),
    );
  }
}
    ...
    return AuthLayout(
      ...
      children: [
        ...
        AppButton(
          label: 'Log in',
          icon: Icons.login_rounded,
          onTap: () => replace(context, const MainShell()),
        ),
      ],
    );
  }
...
class _InterestState extends State<InterestScreen> {
  ...
  final items = const [
    ('AI training', Icons.auto_awesome_outlined),
    ('micro tasks', Icons.ads_click_rounded),
    ('music reviews', Icons.graphic_eq_rounded),
          ...
          child: Column(
            children: [
              ...
              const Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(color: everMuted, height: 1.5),
              ),
              const Spacer(),
              AppButton(
              ...
              TextButton(
                onPressed: () => replace(context, MainShell(userName: name)),
...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PageLayout(
      title: 'good morning, ${name.split(' ').first}',
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: everSurface, borderRadius: BorderRadius.circular(20)),
        child: Row(
          children: [
            Container(
              width: 48,
              ...
              child: Icon(productIcon(product), color: everBlue),
            ),
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(productName(product), style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
                  const SizedBox(height: 3),
                  Text(productText(product), style: const TextStyle(color: everMuted)),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        ...
        children: [
          StepItem(icon: Icons.touch_app_outlined, label: 'task'),
          StepItem(icon: Icons.verified_outlined, label: 'verify'),
          StepItem(icon: Icons.account_balance_wallet_outlined, label: 'withdraw'),
        ],
      ),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(text, style: const TextStyle(color: everMuted, height: 1.45)),
              ],
            ),
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 7),
          const Text('0%', style: TextStyle(color: everMuted)),
        ],
      ),
    );
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(18),
          border: Border.all(color: selected ? everBlue : Colors.transparent),
        ),
        child: Row(
          children: [
            Icon(icon, color: everBlue),
            ...
            Icon(selected ? Icons.check_circle_rounded : Icons.circle_outlined, color: everBlue),
          ],
        ),
      ),
    );
    ...
    builder: (_) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          TextField(controller: account, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Account number')),
        ],
      ),
      actions: [
...
void showWithdrawDialog(BuildContext context) {
  showDialog(
    ...
    builder: (_) => AlertDialog(
      ...
      content: const Text('Your available balance is ₦0.00. Approved earnings can be withdrawn without any unlock or access fee.'),
      actions: [
