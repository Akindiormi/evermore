...
class _OnboardingScreenState extends State<OnboardingScreen> {
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: const EvermoreMark(size: 68, color: Colors.white),
                  ),
                ),
                ...
                const Text(
                  'A practical growth program for people who want to learn, apply and become better on purpose.',
                  style: TextStyle(
                    fontSize: 14,
                    height: 1.55,
  ...
  Widget _goalsPage() {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Your growth goals'),
        leading: IconButton(
      ...
      body: EvermoreBackground(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              'Choose as many as you want. Evermore will use them to shape your learning experience.',
              style: TextStyle(color: EvermoreTheme.muted, height: 1.45, fontSize: 12.5),
            ),
                  ...
                  child: InkWell(
                    ...
                    child: Ink(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(18),
                        border: Border.all(
                          color: isSelected ? EvermoreTheme.primary : EvermoreTheme.divider,
                        ),
                        boxShadow: isSelected ? EvermoreTheme.cardShadow : const [],
                      ),
                      child: Row(
                        children: [
                          Expanded(
  ...
  Widget _profilePage() {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_rounded),
          onPressed: saving ? null : () => setState(() => page = 1),
        ),
      ),
      body: EvermoreBackground(
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 18),
                const Text(
                  "This is how you'll show up",
                  style: TextStyle(fontSize: 25, fontWeight: FontWeight.w800, letterSpacing: -.5),
                ),
                const SizedBox(height: 8),
                const Text(
                  "Add your name and, if you'd like, a photo. This stays on your device only.",
                  style: TextStyle(color: EvermoreTheme.muted, height: 1.45, fontSize: 12.5),
                ),
                ...
                const Spacer(),
                NeoPillButton(
                  label: saving ? 'Creating your path...' : 'Start Evermore',
                  icon: Icons.arrow_forward_rounded,
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: i <= step
                  ...
                  : EvermoreTheme.primary.withValues(alpha: .10),
