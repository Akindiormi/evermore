...
class _ChallengesScreenState extends State<ChallengesScreen> {
  ...
  Future<void> _load() async {
    ...
    if (mounted) {
      setState(() => completed = data);
    }
  }

  @override
  Widget build(BuildContext context) {
    final doneCount = growthChallenges
        .where((challenge) => completed.contains(challenge.id))
        .length;
            ...
            children: [
                ...
                child: Stack(
                  children: [
                    const Positioned(
                      ...
                      child: Opacity(
                        opacity: .12,
                        child: EvermoreMark(size: 95, color: Colors.white),
                      ),
                    ),
                    Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Challenges turn learning into behaviour.',
                          style: TextStyle(
                            color: Colors.white70,
                            fontSize: 11.5,
                            height: 1.4,
                        ...
                        Text(
                          '$doneCount of ${growthChallenges.length} challenges completed',
              ...
              ...growthChallenges.map(
                (challenge) => _ChallengeCard(
                  challenge: challenge,
                  done: completed.contains(challenge.id),
                  onTap: () async {
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) => ChallengeDetailScreen(
                          challenge: challenge,
                          alreadyCompleted: completed.contains(challenge.id),
                        ),
                      ),
                    );
                    await _load();
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    color: done ? Colors.white : EvermoreTheme.primary,
                  ),
                ),
...
class _ChallengeDetailScreenState extends State<ChallengeDetailScreen> {
  ...
  Future<void> complete() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          '+${widget.challenge.xp} XP earned — challenge completed',
        ),
      ),
    );
  }
      ...
      body: EvermoreBackground(
        child: ListView(
          ...
          children: [
            ...
            ...challenge.steps.asMap().entries.map(
              (entry) => Container(
            ...
            NeoPillButton(
              label: saving
                  ...
                  : completed
                      ? 'Challenge completed ✓'
                      : 'Complete challenge +${challenge.xp} XP',
