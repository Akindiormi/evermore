  ...
  Future<void> _submit() async {
    if (_receipt == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Select your payment receipt first')),
      );
      return;
    }
        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              const Text(
                'Make the transfer using the configured payment details below, then submit your receipt.',
                style: TextStyle(
              ...
              _InfoCard(
                ...
                child: Column(
                  children: [
                    _Detail('Bank name', AppConfig.bankName),
                    _Detail('Account name', AppConfig.accountName),
                    _Detail('Account number', AppConfig.accountNumber),
                  ],
                ),
              ),
              const SizedBox(height: 12),
              ...
              const Text(
                'Upload an image of your transfer receipt. You can review it before submitting.',
                style: TextStyle(fontSize: 11, color: EvermoreTheme.muted),
              ),
              const SizedBox(height: 12),
              if (_receipt == null)
                _UploadBox(onTap: _pickReceipt)
              else
                _ReceiptPreview(
              ...
              const Text(
                'Submission means proof has been received. It does not mean payment has been verified or approved.',
      ...
      child: Column(
        children: [
          ...
          TextButton.icon(
            ...
            label: const Text('Choose a different receipt'),
          ),
        ],
      ),
    );
